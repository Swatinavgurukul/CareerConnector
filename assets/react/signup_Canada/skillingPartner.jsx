...
import SignUpPrivacyNpp from "../../frontend/home/signUpPrivacyNpp.jsx"
...
function PartnerSignup(props) {
    ...
    const [user, setUser] = useState({ partnerType: "", organisationName: "", title: "", first_name: "", last_name: "", email: "", area_code: "", phone: "", custom_field2: "", language: "en" });
    ...
    const agreeTerm =()=>{
        ...
        const onScroll = (e,scrollRef) => {
            let box = document.querySelector('.scrollbarDown');
            let content = document.querySelector('.scrolContainer')
                            ...
                            <div onKeyPress={handleKeyPress}>
                                        ...
                                        <div className="d-flex justify-content-around">
                                            <div className="form-check custom-radio">
                                                <input
                                                    ...
                                                    id="nonProfitCheck"
                                                    name="partnerType"
                                                    onChange={(e) => setPartnerType("non-profit")}
                                                    checked
                                                />
                                                <label
                                                    className="form-check-label user-select-none"
                                                    for="nonProfitCheck">
                                                    {t(props.language?.layout?.skilling_signUp)}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="col-md-3">
                                            <div className="form-group animated">
                                                <label
                                                    ...
                                                    for="title">
                                                    {t(props.language?.layout?.skilling_signup_title)}
                                                </label>
                                                <select
                                                    className={
                                                        show_errors.istitle
                                                    ...
                                                    <option disabled selected>
                                                        {t(props.language?.layout?.skilling_signup_select)}
                                                    </option>
                                                    <option value="mr">
                                        ...
                                        <div className="col-md-5">
                                            <div className="form-group animated">
                                                <label
                                                    ...
                                                    for="first_name">
                                                    {t(props.language?.layout?.skilling_signup_firstname)}
                                                </label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="col-md-4">
                                            <div className="form-group animated">
                                                <label
                                                    ...
                                                    for="first_name">
                                                    {t(props.language?.layout?.skilling_signup_lastname)}
                                                </label>
                                ...
                                <div className="col-md-12">
                                    <div className="form-group animated">
                                        <label
                                            ...
                                            for="email">
                                            {t(props.language?.layout?.skilling_signup_email)}
                                        </label>
                                        <input
                                            type="email"
                                            aria-label="email"
                                        ...
                                        <div className="col-xs-12 col-md-4">
                                            <div className="form-group animated">
                                                <label
                                                    ...
                                                    for="area-code">
                                                    {t(props.language?.layout?.skilling_signup_areacode)}
                                                </label>
                                                <select
                                                    className={
                                                        show_errors.isvalidAreaCode
                                                    ...
                                                    <option selected="" className="d-none">
                                                        {t(props.language?.layout?.skilling_signup_select_1)}
                                                    </option>
                                                    <option value="USA +1">
                                                        {t(props.language?.layout?.skilling_signup_selectoption_usa)}
                                                    </option>
                                                    ...
                                                    <option value="Australia +61" disabled>
                                                        {t(
                                                            props.language?.layout
                                                                ?.skilling_signup_selectoption_australia
                                                        )}
                                                    </option>
                                                    <option value="Brazil +55" disabled>
                                                        {t(props.language?.layout?.skilling_signup_selectoption_brazil)}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div className="col-xs-12 col-md-8">
                                            <div className="form-group animated">
                                                <label
                                                    ...
                                                    for="telephone">
                                                    {t(props.language?.layout?.skilling_signup_phone)}
                                                </label>
                                                <input
                                                    type="number"
                                                    aria-label="phone"
                                ...
                                <div className="col-md-12">
                                    ...
                                    <button
                                        ...
                                        onClick={submit}>
                                        {t(props.language?.layout?.skilling_signup_submit)}
                                    </button>
                                    <p className="text-center">
                                        {t(props.language?.layout?.skilling_signup_login1)}{" "}
                                        <a href="/ca/login"> {t(props.language?.layout?.skilling_signup_login2)}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                ...
                <div className="mb-4">
                    <div className="modal-content modal_content p-3 border-0">
                        {/* term and privacy */}
                        <SignUpPrivacyNpp onScroll={onScroll} />
                    </div>
                </div>
                <Modal.Footer>
                    <div className="d-flex justify-content-end">
                            ...
                            <div>
                                <button className="btn btn-primary btn-md px-5 ml-2" disabled={disable} onClick={() => agreeTerm()}>
