...
class ListPagination extends Component {
    ...
    getData() {
        let dataToSort = JSON.parse(JSON.stringify(this.props.data))
        ...
        return (
            <div className="">
                ...
                <div className="d-flex justify-content-between mt-3 mb-1">
                    {this.props.compreApplicantsLength.length === 0 ?
                ...
                <div className="card-body p-0">
                    <div className="table-responsive table-min-height">
                        <table className="table border-bottom candidateTable mb-0">
                            ...
                            <tbody>
                                {/*  {console.log(this.props.type," in index")} */}
                                {this.isLoading ? (
                                    <tr>
                                    ...
                                    this.state.render_data.map((user, index) => (
                                        <RowData
                                            ...
                                            handlerCompareApplicants={this.props.handlerCompareApplicants}
                                        />
                                    ))
                                )}
                            </tbody>
