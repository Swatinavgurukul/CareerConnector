...
class RowData extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        // console.log(nextProps, "sfffsffs")
    }
    scoringNum = (num) => {
        let y = num % 1
        let n = y.toString();
    ...
    render() {
        ...
        // console.log(user, " fdfdfdfd", this.state.expanded)


        return [
            <tr key="main">
                {(this.props.user_type.role_id === 1 || this.props.user_type.role_id === 4) && process.env.CLIENT_NAME === "cc" ?
                    <td className="pl-3 align-middle"><input
                        onChange={(e) => this.props.handlerCompareApplicants(e.target.checked, user.user_id)}
                        className=""
                        type="checkbox"
                        checked={this.props.compareApplicants.find((id) => id == user.user_id)}
                    /></td> : null}
                ...
                {
                    this.props.user_type.role_id === 1 || this.props.user_type.role_id === 4 ? <td className="align-middle">
                        <div
                ...
                < td className="align-middle text-capitalize" >
                    {
                        this.props.user_type.role_id == 2 || this.props.user_type.role_id == 5 ? (
                            <span
                ...
                <td className="pl-3 align-middle text-capitalize">{!user?.answer?.length || user?.answer == "[]" ? "N/A" : user?.answer && JSON.parse(user?.answer)[0]?.answer}</td>
                            ...
                            {user.current_status == "applied" ? (
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button
                                        ...
                                        {t(this.props.language?.layout?.ep_application_interview)}
                                    </button>
                                    <button className="btn btn-light" onClick={() => this.statusChange("on-hold")}>
                                        {t(this.props.language?.layout?.ep_jobtitle_hold)}
                                    </button>
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button className="btn btn-light" onClick={() => this.statusChange("offered", user)}>
                                        {t(this.props.language?.layout?.sp_jobtitle_send)}
                                    </button>
                                    <button className="btn btn-light" onClick={() => this.statusChange("declined")}>
                                        {t(this.props.language?.layout?.sp_jobtitle_decline)}
                                    </button>
                                    <button className="btn btn-light" onClick={() => this.statusChange("hired")}>
                                        {t(this.props.language?.layout?.sp_jobtitle_accepted)}
                                    </button>
                                </div>
                            ) : user.current_status == "rejected" ? (
                                <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <div>
                                    ...
                                    <div className="card border-right border-left rounded-0">
                                        <div className="d-flex p-2 justify-content-between">
                                            ...
                                            {this.props.user_type.role_id == 2 || this.props.user_type.role_id == 5 ? (
                                                <div className="d-flex align-items-center pl-0 pr-4"></div>
                                            ) : (
