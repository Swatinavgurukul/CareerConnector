        ...
        <div>
            <div className="masthead-homepage">
                <div className="content-overlay w-100">
                    <img src="/uploads/user_v1llv353bppo/atlanta.jpg" alt="home cover" width="100%" />
                </div>
                <div>
                ...
                <div class="row mt-5">
                    <div class="col-md-10 offset-md-1 col-sm-12">
                        ...
                        <div className="row">
                            ...
                            <div class="col">
                                <a href="/location/houston">
                                    <img
                                        src="/uploads/user_v1llv353bppo/city_houston.jpg"
                                        alt="houston"
                                        class="img-fluid"
                                        width="100%"
                                    />
                                    <div class="pt-2 h5">Houston</div>
                                </a>
                            </div>
                            <div class="col">
                                <img
