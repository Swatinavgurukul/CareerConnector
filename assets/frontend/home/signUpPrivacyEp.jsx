                        ...
                        <div>
                            <div>
                                ...
                                <div>
                                    ...
                                    <p>{t(props.language?.layout?.termsofservice_link1)}
                                    <a href="/terms-of-service" target="_blank">{t(props.language?.layout?.termsofservice)}</a>
                                    {t(props.language?.layout?.termsofservice_link2)}.</p>
                                </div>
                            </div>
                        </div>
                    </div>
