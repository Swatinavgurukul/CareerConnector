                ...
                <div className="row">
                    ...
                    <div className="col-md-offset-4 col-md-4 m-auto">
                        <div className="auth-trans-bg rounded p-2">
                            ...
                            <p class="text-center">
                                {t(props.language?.layout?.forgot_password_signin1)}<a href="/login"> {t(props.language?.layout?.forgot_password_signin2)}</a> {t(props.language?.layout?.forgot_password_signin3)}
                            </p>
                        </div>
                    </div>
                </div>
