            ...
            .then((response) => {
                if (response.status === 200) {
                    ...
                    if (decoded.is_consent === false) {
                        ...
                        // }
                        // window.location.href = "/jobs";
                        if (props.location.state !== undefined && decoded.role_id == 1) {
                                ...
                                <div className="col-md-12">
                                   ...
                                   Sign in with Indeed
                                    ...
                                    <div className="text-center m-3">
                                        <a href="/ca/forgotPassword" className="text-primary">
                                            {t(props.language?.layout?.login_forgotpassword)}
                                        </a>
                                    </div>

                                    <p className="text-center">
                                        {t(props.language?.layout?.login_signup1)} <a href="/ca">{t(props.language?.layout?.login_signup2)}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default connect(mapStateToProps, { _setAuthData, _billingAuth })(Login);
