                            ...
                            <div onKeyPress={handleKeyPress}>
                                        ...
                                        <div className="d-flex justify-content-around">
                                            <div className="form-check custom-radio">
                                                <input
                                                    ...
                                                    checked
                                                />
                                                <label class="form-check-label user-select-none" for="nonProfitCheck">
                                                    Signup as Skilling Partner
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-12">
                                    <div className="form-group animated">
                                        <label
                                            className={
                                                isValidOrgName ? "form-label-active text-green" : "form-label-active text-danger bg-white"
                                            }
                                    ...
                                    <div className="row">
                                        <div className="col-md-3">
                                            <div class="form-group animated">
                                                <label
                                                    className={
                                                        istitle ? "form-label-active text-green" : "form-label-active text-danger bg-white"
                                                    }
                                                    for="title">
                                                    Title
                                                </label>
...
export default connect(mapStateToProps, { _setAuthData })(PartnerSignup);
