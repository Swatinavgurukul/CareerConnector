        ...
        axios
            ...
            .then((response) => {
                if (response.data.data.description.length > JobDescriptionLimit) {
                    ...
                    setDseEn(response.data.data.description)
                    setDseEsp(response.data.data.description_esp)
                    setDseFr(response.data.data.description_fr)
                    let job_desc;
                    {
                        props?.languageName == "en" ?
                            job_desc = response.data.data.description : ""
                    }
                    {
                        props?.languageName == "esp" ?
                            job_desc = response.data.data.description_esp == null || "" ? response.data.data.description : response.data.data.description_esp : ""
                    }
                    {
                        props?.languageName == "fr" ?
                            job_desc = response.data.data.description_fr == null || "" ? response.data.data.description : response.data.data.description_fr : ""
                    }
                        ...
                        <div className="col-lg-6 col-md-5 p-0 mb-md-0 mb-4">
                            <div>
                                {props?.languageName == "en" ?
                                    <h2>{job.title}</h2> : ""}
                                {props?.languageName == "esp" ?
                                    <h2>{job.title_esp == null || job.title_esp == "" ? job.title : job.title_esp}</h2> : ""}
                                {props?.languageName == "fr" ?
