                ...
                <div className="card-body">
                    ...
                    <div class={props.loading ? "skeleton-glow" : "text-justify small text-muted mb-0 mt-3"}>
                        ...
                        <div>
                            ...
                            {props.languageName == "en" ? ReactHtmlParser(truncateOnSpaces(plainText(props.item.description), 200)) : ""}

                            {props.languageName == "esp" ?
                                props.item.description_esp == null || props.item.description_esp == "" ? ReactHtmlParser(truncateOnSpaces(plainText(props.item.description), 200)) : ReactHtmlParser(truncateOnSpaces(plainText(props.item.description_esp), 200)) : ""}
                            {props.languageName == "fr" ?
                ...
                <div className="card-footer bg-white text-dark mb-3 mt-3 px-3 m-0 p-0 border-top-0">
                    <div className="d-flex mb-0 justify-content-between">
                        ...
                        <div className="text-right">
                            <Link
                                to={{
                                    pathname: `/ca/jobs/${props.item.slug}`,
