            ...
            <div className="">
                ...
                <div className="row mt-3">
                    <div className="col-md-12 col-lg-5 d-flex">
                        ...
                        <p className="my-2 px-2 text-muted" style={{ wordBreak: "normal"}}> {t(this.props.language?.layout?.js_of)}  {this.state.filtered_data.length} {t(this.props.language?.layout?.all_items_nt)}</p>
                    </div>
                    <div className="col-md-12  col-lg-7 d-flex justify-content-end">
                        <ReactPaginate
