                    ...
                    <div className="table-responsive">
                        <table className="table border-bottom mb-0">
                            <thead className="text-white" style={this.props.theme.tableHeader_background}>
                                <TableHeader
                                    tableJSON={this.props.tableJSON}
                                    sortEnabled={true}
                                    actionToDo={this.performAction}
                                    sortArrow={this.renderSortArrow}
                                />
                            </thead>
                            <tbody>
                                {this.state.render_data.map((item, index) => (
                                    <RowData
                                        ...
                                        item={item}
                                        index={index}
                                        actionsJSON={this.props.actionsJSON}
                                        actionToDo={this.performAction}
                                        actionsToPerform={this.props.actionsToPerform}
                                        showJobCard={this.props.showJobCard}
                                        hideJobCard={this.props.hideJobCard}
                                        getAppliedData={this.props.getAppliedData}
                                    />
                                ))}
                            </tbody>
                        </table>
