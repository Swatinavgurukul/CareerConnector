    ...
    render() {
        ...
        return [
            <tr key="main">
                ...
                {this.props.userAdmin.role_id == 1 || this.props.userAdmin.role_id == 4 ?
                ...
                {this.props.userAdmin.role_id !== null &&
                    <Fragment>
                        <td className="pl-3 align-middle">{renderToLocaleDate(user.interview_date)}</td>
                        <td className="pl-3 align-middle">{user.interview_duration}</td>
                    </Fragment>
                }
                                    ...
                                    <div className="card border-right border-left rounded-0">
                                        <div className="d-flex p-2 justify-content-between">
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="">
                                                    ...
                                                    <div className="d-flex">
                                                        <p className="d-flex align-items-center mb-0 icon-invert">
                                                            <img
                                            ...
                                            <div className="d-flex align-items-center pl-0">
                                                {this.props.userAdmin.role_id == 1 ? <div className="d-flex align-items-center pl-0">
                                            ...
                                            <div className="d-flex flex-column justify-content-center align-items-start px-0">
                                                ...
                                                <strong>{t(this.props.language?.layout?.ep_interviews_appliedon)}</strong>
                                                <span className="text-muted">
                                                ...
                                                <div>
                                                    <div className="pb-3">
                                                        <a
                                                            ...
                                                            className="icon-invert btn-svg-sm rounded btn-light text-decoration-none d-flex pr-0"
                                                            style={{ wordBreak: "break-all" }}
                                                            ...
                                                            <img
                                                                ...
                                                                alt="search"
                                                                className={` svg-xs ${user.resume == null || user.resume == ""
                                                                    ? "disabled"
                                                                    : ""
                                                                    }`}
                                                            />
                                                            <span className="ml-2">{t(this.props.language?.layout?.ep_interviews_downloadresume)}</span>
                                                        </a>
                                                    </div>
                                                    <div className="">
                                                        <Link
                                                            ...
                                                            />
                                                            <span>{t(this.props.language?.layout?.ep_interviews_view)}</span>
                                                        </Link>
                                                    </div>
                                                    {/* <div>
                                                    <img
