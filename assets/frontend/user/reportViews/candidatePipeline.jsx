        ...
        dataList.map((each) => {
            formatedDataList.push({
                single: [
                    ...
                    { name: t(props.language?.layout?.reports_jobopen_nt), value: each.job_start_date },
                    { name: t(props.language?.layout?.reports_jobclose_nt), value: each.job_end_date },
                    ...
                    { name: t(props.language?.layout?.ep_jobs_jobtype), value: each.job_type },
                    { name: t(props.language?.layout?.ep_jobtitle_location), value: each.location },
                ],
                double: [
                    {
                        head: "Count",
                ...
                <div className="row pt-4 px-3 gray-100">
                    <div class="col-md-12 my-2 p-0">
                        <div class="d-flex align-items-center justify-content-between icon-invert">
                            ...
                            {!disable ?
                            <button
                                className={data.length ? "icon-invert d-flex btn btn-primary" : "btn btn-outline-secondary"}
...
export default connect(mapStateToProps, {})(CandidatePipeline);
