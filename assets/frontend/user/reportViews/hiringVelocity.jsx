    ...
    const AlignAlphaAndNumberInTable = (dataList) => {
        ...
        dataList.map((each) => {
            formatedDataList.push({
                single: [
                    { name: t(props.language?.layout?.reports_jobstage_nt) , value: each.status },
                ],
                double: [
                    {
                        head: "Job",
                        data: [
                            { name: t(props.language?.layout?.reports_countofjs_nt), value: each.count },
                            // { name: "created_at", value: each.created_at },
                    ...
                    },
                    {
                        head: "Count",
                        data: [
                            { name: t(props.language?.layout?.reports_avgdays_nt), value: each.average },
...
export default connect(mapStateToProps, {})(HiringVelocity);
