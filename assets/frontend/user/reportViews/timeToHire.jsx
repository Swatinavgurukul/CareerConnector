    ...
    const AlignAlphaAndNumberInTable = (dataList) => {
        ...
        dataList.map((each) => {
            formatedDataList.push({
                single: [
                    // { name: t(props.language?.layout?.ep_setting_cd_title), value: each.title },
                    {
                        name: t(props.language?.layout?.ep_setting_cd_title),
                    ...
                    { name: t(props.language?.layout?.ep_createjob_function), value: each.job_function },
                    { name: t(props.language?.layout?.reports_hiredjs_nt), value: each.hired_job_seeker },
                    { name: t(props.language?.layout?.reports_jobopen_nt), value: each.job_open_date },
                    { name: t(props.language?.layout?.reports_jobclose_nt), value: each.job_close_date },
                ...
                double: [
                    {
                        head: "Job",
                        data: [
                            { name: t(props.language?.layout?.reports_tofill_nt), value: each.time_to_fill },
                            { name: t(props.language?.layout?.reports_tohire_nt), value: each.time_to_hire },
                            // { name: "type", value: each.job_type },
...
export default connect(mapStateToProps, {})(TimeToHire);
