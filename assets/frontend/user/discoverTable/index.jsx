...
class ListPagination extends Component {
    ...
    handlePageChange = (datapage) => {
        this.props?.pageNumberHandler(datapage.selected + 1)
    ...
    getData() {
        let dataToSort = JSON.parse(JSON.stringify(this.props.data.data));
        ...
        let pageCount = this.props?.data?.total_pages;
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-md-8 col-12 d-flex justify-content-end">
                        <ReactPaginate
                            ...
                            forcePage={this.props?.data.page_number - 1}
                            pageRangeDisplayed={4}
                            onPageChange={this.handlePageChange}
                            subContainerClassName={"pages pagination"}
                            activePage={this.props?.data.page_number - 1}
                            initialPage={this.props?.data.page_number - 1}
