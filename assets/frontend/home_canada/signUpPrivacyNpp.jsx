...
const SignUpPrivacyNpp = (props) => {
    const { t } = useTranslation();
    let scrollref= useRef()

    return (
        <div className="w-100 epModal mt-3 thin-scrollbar scrollbarDown" ref={scrollref}  onScroll={(e)=>props.onScroll(e,scrollref)}>
            <div className="container scrolContainer">
                <div className="row" >
                        ...
                        <div>
                            <div>
                                <div id="section_New">
                                    ...
                                    By signing up as an Skilling Partner you agree that you:
                                    </h3> */}
                                    <p className="font-weight-bold">
                                        {/* Employer should self-attest as part of registration they: */}
                                        {t(props.language?.layout?.sppolicy_heading_nt)}:
                                        </p>
                                    <p className="h5-small">
                                    <span><img src="/svgs/icons_new/check-vector.svg" alt="-"/>
                                        </span>	{t(props.language?.layout?.sppolicy_info1_nt)}

                                    </p>
                                    <p className="h5-small">
                                    <span><img src="/svgs/icons_new/check-vector.svg" alt="-"/>
                                        </span>	{t(props.language?.layout?.sppolicy_info2_nt)}

                                    </p>
                                    <p className="h5-small">
                                    <span><img src="/svgs/icons_new/check-vector.svg" alt="-"/>
                                        </span>	{t(props.language?.layout?.sppolicy_info3_nt)}

                                    </p>
                                    <p className="h5-small">
                                    <span><img src="/svgs/icons_new/check-vector.svg" alt="-"/>
                                        </span>	{t(props.language?.layout?.sppolicy_info4_nt)}

                                    </p>
                                    <p className="h5-small">
                                    <span><img src="/svgs/icons_new/check-vector.svg" alt="-"/>
                                        </span>	{t(props.language?.layout?.sppolicy_info5_nt)}</p>
                                </div>
                                <div id="section_1">
                                    {/* <h3 className="font-weight-bold">{t(props.language?.layout?.policy_heading)}</h3> */}
                                    <p className="font-weight-bold mt-2">
                                    {t(props.language?.layout?.sppolicy_info6_nt)}:
                                    </p>
                                    <p>
...
export default connect(mapStateToProps)(SignUpPrivacyNpp);
